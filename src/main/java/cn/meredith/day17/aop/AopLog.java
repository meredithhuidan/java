...
public class AopLog {
    ...
    @Before("execution(* cn.meredith.day17.UserService.add())")
    public void before(){
        System.out.println("前置通知 在方法之前执行...");
    }

    @After("execution(* cn.meredith.day17.UserService.add())")
    public void after(){
        System.out.println("后置通知 在方法之后执行...");
    }

    @AfterReturning("execution(* cn.meredith.day17.UserService.add())")
